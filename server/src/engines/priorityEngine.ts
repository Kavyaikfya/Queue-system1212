...
export interface PriorityInput {
  ...
  isUrgent?: boolean;
  serviceBasePriority?: number;
  serviceCategory?: string;
  queueRules?: {
    wait_time_aging_weight?: number; // default: 1.5 pts per 5 min
    urgency_boost_weight?: number;   // default: 40.0 pts
    appointment_boost_weight?: number; // default: 15.0 pts
    service_category_weight?: number;  // default: 1.0
  };
}
...
export class PriorityEngine {
   ...
   */
  public static calculate(input: PriorityInput): PriorityResult {

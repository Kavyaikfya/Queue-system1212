...
export class SimulatorEngine {
    static DISCLAIMER = 'Simulation results are model-based operational predictions and do not represent guaranteed real-world outcomes.';
    static runScenario(scenario) {
        ...
        const baseWait = Math.round(Math.ceil(baseLength / baseCounters) * baseServiceMin);
        ...
        const projServiceMin = Math.round(baseServiceMin * (scenario.serviceDurationMultiplier || 1.0) * 10) / 10;

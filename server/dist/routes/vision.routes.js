...
router.post('/analyze', async (req, res) => {
    try {
        ...
        const recommendation = density === 'HIGH'
        ...
        const result = {
            disclaimer: 'AI-generated visual estimate based on scene density analysis. Actual queue conditions may differ. No biometric or face identification data is collected or retained.',
